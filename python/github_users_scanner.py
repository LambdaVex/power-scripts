...
followers_data = requests.get("https://api.github.com/users/[USER]/followers?per_page=2000").json()
following_data = requests.get("https://api.github.com/users/[USER]/following?per_page=2000").json()
